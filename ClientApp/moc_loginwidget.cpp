...
QT_MOC_LITERAL(1, 12, 16), // "signal_loginInfo"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 2), // "ID"
QT_MOC_LITERAL(4, 33, 20), // "signal_createAccount"
QT_MOC_LITERAL(5, 54, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(6, 76, 23) // "on_pushButton_2_clicked"

    },
    "LoginWidget\0signal_loginInfo\0\0ID\0"
    "signal_createAccount\0on_pushButton_clicked\0"
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signal_loginInfo((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->signal_createAccount(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::signal_loginInfo)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::signal_createAccount)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginWidget::signal_loginInfo(QString _t1)
{
...
// SIGNAL 1
void LoginWidget::signal_createAccount()
{
